			...
			(function(type, view){
				...
				view['get' + type] = function (byteOffset, littleEndian) {
					...
					if (size === 1 || ((view._start + byteOffset) % size === 0 && littleEndian)) {
						...
						buffer = new Uint8Array(view.getBytes(byteOffset, size, littleEndian)).buffer;
						offset = 0;
					}
...
jDataView.prototype = {
	...
	_getBytes: function (byteOffset, length, littleEndian) {
		var result;
	...
	getBytes: function (byteOffset, length, littleEndian) {
	...
	getString: function (byteOffset, length) {
		return String.fromCharCode.apply(null, this._getBytes(byteOffset,length, true));
	},
	...
	getChar: function (byteOffset) {
		return this.getString(byteOffset,1);
	},

	setChar: function (byteOffset, _char) {
		this.setString.apply(this, arguments);
	},

	writeChar: function (_char) {
		this.setChar(undefined, _char);
	},
	...
	slice: function (start, end, forceCopy) {
		return forceCopy
			   ? new jDataView(this.getBytes(start, end-start), undefined, undefined, true)
	...
	_getFloat64: function (byteOffset, littleEndian) {
		var b = this._getBytes(byteOffset, 8, littleEndian),
	...
	_getFloat32: function (byteOffset, littleEndian) {
		var b = this._getBytes(byteOffset, 4, littleEndian),
	...
	_getUint16: function (byteOffset, littleEndian) {
		var b = this._getBytes(byteOffset,2, littleEndian);
		return (b[1] << 8) | b[0];
	},
	...
	_getUint8: function (byteOffset) {
		return this._getBytes(byteOffset,1)[0];
	},
